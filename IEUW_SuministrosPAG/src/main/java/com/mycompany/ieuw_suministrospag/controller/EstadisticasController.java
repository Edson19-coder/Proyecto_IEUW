...
public class EstadisticasController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<VentasMesModel> ventas = VentasDAO.GetVentasMes();
            Float ventaMesTotal = VentasDAO.GetVentasTotal();
            Float ventaMesTotalAño = VentasDAO.GetVentasTotalAño();
            InStockModel activos = ProductDAO.GetInStock();
            request.setAttribute("ventasPorMes", ventas);
            request.setAttribute("ventaMesTotal", ventaMesTotal);
            request.setAttribute("ventaMesTotalAño", ventaMesTotalAño);
